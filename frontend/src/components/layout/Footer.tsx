      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          ...
          <div className="footer-section footer-brand">
            <Link to="/" className="footer-logo">
              ...
              <span className="footer-logo-text">Réussir</span>
            </Link>
            <p className="footer-description">
              Plateforme d'accès aux sujets d'examens et concours pour aider les étudiants à réussir.
            </p>
            {/* Réseaux sociaux */}
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            © {currentYear} Réussir. Tous droits réservés.
          </p>
          <div className="footer-language">
            <button className="language-button" aria-label="Changer de langue">
              <svg

...
└──────────────────┬──────────────────────────┘
        ...
        └──────────┬───────────┘
                   │
        ┌──────────▼──────────────────┐
        │   Flask AI Service (Python) │  ← Port 5000
        ├─────────────────────────────┤
        │ • NLP Analyzer              │
        │ • Recommender Engine        │
        │ • Success Predictor         │
...
Tous les endpoints Flask sont accessibles via le gateway avec validation et gestion d'erreurs améliorées :
...
2. **Rate Limiting** : Limiter les appels API (Flask-Limiter)

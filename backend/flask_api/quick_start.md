...
✅ Flask devrait démarrer sur `http://localhost:5000`

### Étape 4 : Tester Flask (30 sec)
...
Ce script va :
- ✅ Tester tous les endpoints Flask
...
### Problème : "Connection refused" sur Flask
...
# Vérifier les logs
# Dans le terminal où Flask tourne, regarder les erreurs
...
# Vérifier les logs
docker-compose logs -f flask_service
...
- [ ] Flask démarre sans erreur sur port 5000

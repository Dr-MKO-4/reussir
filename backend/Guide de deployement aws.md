...
## **Étape 5 : Configuration Flask (Python)**
...
### **5d. Installer les dépendances Flask**
```bash
...
```
[Unit]
Description=Flask Educational AI Service
After=network.target

[Service]
Type=simple
User=ubuntu
WorkingDirectory=/home/ubuntu/projects/reussir/backend/flask_api
Environment="PATH=/home/ubuntu/projects/reussir/backend/flask_api/venv/bin"
ExecStart=/home/ubuntu/projects/reussir/backend/flask_api/venv/bin/python app.py
Restart=always
RestartSec=10
...
5. Ajoutez :
   - Port 5000 (Flask) - Source : votre frontend
...
```bash
cd ~/projects/reussir/backend/flask_api
source venv/bin/activate
python app.py
```

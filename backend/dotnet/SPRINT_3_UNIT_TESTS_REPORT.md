...
- [ ] Verify Flask service connectivity
- [ ] Test AI endpoints against real Flask backend
...
public async Task GetRecommendationsAsync_WithValidInput_ReturnsRecommendations()
{
    ...
    _mockFlaskClient.Setup(x => x.GetRecommendationsAsync(...))
        .ReturnsAsync(mockResponse);

    // Act
    var result = await _mockFlaskClient.Object.GetRecommendationsAsync(...);
...
**Ready for Bridge 3: Flask Integration**

...
namespace backend.Tests
{
    ...
    /// <summary>
    /// Mock FlaskClient for testing
    /// </summary>
    public interface IMockFlaskClient
    {
    ...
    {
        private readonly Mock<IFlaskClient> _mockFlaskClient;
        ...
        public AIServiceTests()
        {
            ...
            _aiService = new AIService(_mockFlaskClient.Object, _mockLogger.Object);
        }
    ...
    /// <summary>
    /// Unit tests for the FlaskClient class
    /// Tests HTTP communication with Flask AI backend
    /// </summary>
    public class FlaskClientTests
    {
        [Fact]
        public void FlaskClient_Constructor_InitializesSuccessfully()
        {
            // Arrange
            var mockHttpClient = new Mock<System.Net.Http.HttpClient>();
            var mockLogger = new Mock<ILogger<FlaskClient>>();
            var mockConfig = new Mock<Microsoft.Extensions.Configuration.IConfiguration>();

            // Act
            var client = new FlaskClient(mockHttpClient.Object, mockLogger.Object, mockConfig.Object);

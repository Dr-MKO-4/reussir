...
namespace SprintBackendTests
{
    ...
    public class Enrollment { public int Id { get; set; } public int UserId { get; set; } public int SubjectId { get; set; } public DateTime EnrollmentDate { get; set; } }
    ...
    public class EnrollmentServiceTests
    {
        ...
        {
            var enrollment = new Enrollment { Id = 1, UserId = 1, SubjectId = 1, EnrollmentDate = DateTime.Now };
